...
//  Today
//
//  Created by Wade Yuan on 6/2/2023.
//
...
enum TodayError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .accessDenied:
            return NSLocalizedString("The app doesn't have permission to read", comment: "access denied error description")
        case .accessRestricted:
        ...
        case .unknown:
            return NSLocalizedString("An unknown error occured", comment: "unknown erro description")
        }
    }
}
